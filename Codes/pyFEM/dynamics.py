...
# --------------------------------------------------
# --------------------------------------------------
#from input.dynamics_tyre import gmshfile, materials, solid, dbc, dbcn, tbc, bf, tf, Dt, output_interval, v0, Lambda
...
from B3elemental import B3_Fe_contact, B3_Fe_contact_friction
...
for step in range(1, nstep + 1):
    ...
    for e in range(analysis.NB3):
        ...
        Xe = nodes.coor[conn, :DG]
        Ge = nodes.dof[conn, :ndof].reshape(-1)
#        Fe = B3_Fe_contact(Xe, U[Ge].reshape(ne, ndof), Lambda)        
